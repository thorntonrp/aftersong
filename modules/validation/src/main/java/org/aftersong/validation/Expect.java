...
/**
 * Provides exception-based argument validation against expected values.
 * Operations that succeed will do nothing while operations that fail will
...
public class Expect {
	 ...
	 */
	public static void isEmpty(Object[] values) throws IllegalArgumentException {
		if (!Check.isEmpty(values)) {
			throw new IllegalArgumentException("expected empty array");
		}
	}
	...
	public static void isEmpty(Collection<?> values) {
		if (!Check.isEmpty(values)) {
			throw new IllegalArgumentException("expected empty collection");
		}
	}
	...
	public static void isEmpty(Map<?, ?> values) {
		if (!Check.isEmpty(values)) {
			throw new IllegalArgumentException("expected empty map");
		}
	}
	...
	public static void isNotEmpty(Map<?, ?> values) {
		if (Check.isEmpty(values)) {
			throw new IllegalArgumentException("expected non-empty map");
		}
	}
	...
	public static void isEmpty(String value) {
		if (!Check.isEmpty(value)) {
			throw new IllegalArgumentException("expected empty string");
		}
	}
	...
	public static void isBlank(String value) {
		if (!Check.isBlank(value)) {
			throw new IllegalArgumentException("expected blank string");
		}
	}
	...
	public static void equal(Object value1, Object value2) {
		if (value1 == value2) {
			...
			throw new IllegalArgumentException("arguments are not equal");
